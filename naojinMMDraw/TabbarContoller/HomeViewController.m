...
- (void)viewDidLoad
{
    ...
    [leftButton setFrame:CGRectMake(15, self.view.frame.size.height - 120, 150, 50)];
    leftButton.layer.borderColor = [[UIColor redColor] CGColor];
    leftButton.layer.borderWidth = 2.f;
    ...
    rightButton.frame = CGRectMake(self.view.frame.size.width - 150 - 15, self.view.frame.size.height - 120, 150, 50);
    [rightButton setTitle:@"下一题" forState:UIControlStateNormal];
